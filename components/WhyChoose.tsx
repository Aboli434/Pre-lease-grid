...
export default function WhyChoose() {
  return (
    <section className="w-full mt-40 mb-20">
      ...
      {/* MAIN AREA */}
      <div className="mt-20 flex justify-center gap-20 px-10">
        {/* LEFT IMAGE */}
        <div className="relative w-[350px] h-[420px] flex-shrink-0">
          <Image
            src="/images/whychoose-illustration.png"
        ...
        {/* RIGHT FEATURES */}
        <div className="flex flex-col gap-14 w-[520px]">
            ...
            return (
              <div key={index} className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  <h3 className="text-2xl font-semibold text-gray-900 leading-snug whitespace-nowrap">
                    {item.title}
                  </h3>

                  <p className="text-gray-600 text-lg leading-relaxed mt-3 pr-4">
                    {item.desc}
                  </p>
          ...
          {/* BUTTON */}
          <div className="pt-2 mx-auto w-max">
            <button className="bg-red-600 text-white text-lg font-semibold px-8 py-3 rounded-md shadow-[0_4px_20px_rgba(0,0,0,0.06)] hover:bg-red-700 transition">
              Explore more
            </button>
          </div>
        </div>
